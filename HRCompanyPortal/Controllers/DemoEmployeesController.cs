...
{
    public class DemoEmployeesController : Controller
    {
        private readonly HRComPortalDbContext _context;

        public DemoEmployeesController(HRComPortalDbContext context)
        {
            _context = context;
        }
        ...
        // GET: DemoEmployees/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: DemoEmployees/Create
